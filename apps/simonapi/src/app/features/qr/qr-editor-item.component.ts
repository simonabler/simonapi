...
@Component({
  standalone: true,
  selector: 'app-qr-editor-item',
  imports: [CommonModule, ReactiveFormsModule, LucideAngularModule],
  templateUrl: './qr-editor-item.component.html',
  styleUrls: ['./qr-editor-item.component.scss']
})
export class QrEditorItemComponent implements OnInit, OnDestroy {
